...
rouge = Rouge()
sigmas = [0.0000000025,0.000000005,0.0000000075,0.000000025,0.00000005,0.000000075, 0.00000025,0.0000005,0.00000075]
...
for sig in sigmas:
    ...
    resultComp.write(str(sig) + "," + str(sum_r1_r / 500) + "," + str(sum_r1_p / 500) + "," + str(
        ...
        sum_r2_f / 500) + "," + str(sum_rl_r / 500) + "," + str(sum_rl_p / 500) + "," + str(sum_rl_f / 500)+",0.441516747,0.490588947,0.381699937,0.445846941\n")
